...
// if $require_login was set and value is 'true' // if user not yet logged in, redirect to login page
...
// if it was the 'login' or 'register' or 'sign up' page but the customer was already logged in // if user not yet logged in, redirect to login page
